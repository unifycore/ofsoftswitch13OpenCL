...
#match= parser.OFPMatch(eth_type=0x0806, arp_op=2, arp_tpa=DISCOVERY_ARP_IP)
	...
	if datapath.id in FIRST_EDGE_FORWARDER:
		...
		actions = [parser.OFPActionSetField(ipv4_src="172.16.0.20"),parser.OFPActionOutput(3)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionSetField(ipv4_src="172.16.0.30"),parser.OFPActionOutput(4)]
		self.add_flow(datapath, 50, match, actions)
	...
	if datapath.id in LAST_EDGE_FORWARDER:
		...
		actions = [parser.OFPActionSetField(ipv4_src="172.16.0.1"),parser.OFPActionOutput(4)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=4,eth_type=0x800,ip_proto=6,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.2")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(1)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(2)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=2,eth_type=0x800,ip_proto=6,ipv4_dst="172.16.0.3",ipv4_src="172.16.0.20")
		actions = [parser.OFPActionSetField(ipv4_src="172.16.0.1"),parser.OFPActionOutput(4)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=4,eth_type=0x800,ip_proto=6,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.3")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(2)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(3)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=3,eth_type=0x800,ip_proto=6,ipv4_dst="172.16.0.4",ipv4_src="172.16.0.30")
		actions = [parser.OFPActionSetField(ipv4_src="172.16.0.1"),parser.OFPActionOutput(4)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=4,eth_type=0x800,ip_proto=6,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.4")
