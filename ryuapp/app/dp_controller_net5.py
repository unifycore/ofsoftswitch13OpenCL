...
class SimpleSwitch13(app_manager.RyuApp):
	...
	if datapath.id in FIRST_EDGE_FORWARDER:
		...
		actions = [parser.OFPActionOutput(1)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=1,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.5")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(5)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=5,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(1)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(1)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=1,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.6")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(6)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=6,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(1)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(1)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=1,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.7")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(7)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=7,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(1)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(1)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=1,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.8")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(8)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=8,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(1)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(1)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=1,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.9")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(1)]
		self.add_flow(datapath, 50, match, actions)
	...
	if datapath.id in LAST_EDGE_FORWARDER:
		...
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.2")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(1)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.3")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(2)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.4")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(3)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(4)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=4,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.5")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.5")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(4)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(5)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=5,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.6")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.6")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(5)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(6)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=6,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.7")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.7")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(6)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(7)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=7,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.8")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.8")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(7)]
		self.add_flow(datapath, 50, match, actions)
		...
		actions = [parser.OFPActionOutput(8)]
		self.add_flow(datapath, 100, match, actions)
		match = parser.OFPMatch(in_port=8,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.9")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(9)]
		self.add_flow(datapath, 50, match, actions)
		match = parser.OFPMatch(in_port=9,eth_type=0x800,ip_proto=1,ipv4_dst="172.16.0.1",ipv4_src="172.16.0.9")
		actions = [parser.OFPActionDecNwTtl(),parser.OFPActionOutput(8)]
		self.add_flow(datapath, 50, match, actions)
